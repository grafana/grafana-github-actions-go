...
func findIssues(ctx context.Context, lister utils.RemoveMilestoneClient, milestone *gh.Milestone, currentVersion string) ([]*gh.Issue, error) {
...
func removeMilestone(ctx context.Context, deleter utils.RemoveMilestoneClient, issues []*gh.Issue, milestone *gh.Milestone, currentVersion string) error {
	for _, issue := range issues {
		...
		_, _, err = deleter.CreateComment(ctx, "grafana", utils.RepoName, *issue.Number, &gh.IssueComment{Body: &commentContent})
		if err != nil {
