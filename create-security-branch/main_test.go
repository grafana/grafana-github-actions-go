	...
	}{
		{
			...
			mockSetup: func(m *MockGitClient) {
				m.GetRefFunc = func(ctx context.Context, owner string, repo string, ref string) (*github.Reference, *github.Response, error) {
					if ref == "heads/release-12.0.1+security-01" {
			...
			expectedBranch: "release-12.0.1+security-01",
			expectError:    false,
		},
		{
			...
			mockSetup: func(m *MockGitClient) {
				m.GetRefFunc = func(ctx context.Context, owner string, repo string, ref string) (*github.Reference, *github.Response, error) {
					return &github.Reference{
						Ref: github.String("heads/release-12.0.1+security-01"),
					}, &github.Response{}, nil
				}
			},
			expectedBranch: "",
			expectError:    true,
			errorMessage:   "security branch release-12.0.1+security-01 already exists",
		},
		{
